...
with st.form("transaction_form", clear_on_submit=True):
    ...
    with col2:
        ...
        # Naya Feature: Time Input (Optional)
...
if submit and person_name and amount > 0:
    ...
    new_row = pd.DataFrame([{
        ...
        "Currency": currency, 
        "Type": t_type, 
        # User ki di hui date aur time use hogi
    ...
    try:
        ...
        st.success(f"Record save ho gaya: {manual_date}")
        st.balloons()
...
if st.checkbox("Show History"):
    ...
    if not history_df.empty:
        # Date ke mutabiq sort karein taake nayi entries upar ayein
